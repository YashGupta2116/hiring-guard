...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn("border-b border-border bg-secondary/35 text-muted-foreground font-medium text-[11px]", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "transition-colors hover:bg-secondary/40 data-[state=selected]:bg-muted",
      className
    )}
    {...props}
  />
